...
const Jupiter=function(sun){
    ...
    this.r=this.w/2;
    //公转相关
    this.revolveRadius=sun.r+sun.rur*5.2+this.r;
    this.revolveSpeed=sun.earthRus*0.435333333;
...
Jupiter.prototype.paint=function(g){
    g.save();
    
    g.beginPath();
    g.arc(0, 0, this.revolveRadius, 0, g.PI2);
    g.strokeStyle = "#EDC772";
    g.stroke();
