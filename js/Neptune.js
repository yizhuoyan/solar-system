...
const Neptune=function(sun){
    ...
    this.r=this.w/2;
    //公转相关
    this.revolveRadius=sun.r+sun.rur*30.06+this.r;
    this.revolveSpeed=sun.earthRus*0.181;
...
Neptune.prototype.paint=function(g){
    g.save();
    
    g.beginPath();
    g.arc(0, 0, this.revolveRadius, 0, g.PI2);
    g.strokeStyle = "#6A93F9";
    g.stroke();
